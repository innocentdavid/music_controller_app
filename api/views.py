...
def index(reqeust):
    return HttpResponse('<h1 class="warning"> You are not welcomed here! </h1>')
...
class GetRoom(APIView):
    ...
    def get(self, request, format=None):
        ...
        return Response({'msg': "Code parameter not found in request"}, status=status.HTTP_400_BAD_REQUEST)
